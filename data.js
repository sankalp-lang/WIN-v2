...
window.DB = {
  ...
  districtShares: {
    ...
    'Gujarat':        [{ n: 'Ahmedabad', p: 30 }, { n: 'Surat', p: 24 }, { n: 'Vadodara', p: 15 }, { n: 'Rajkot', p: 12 }, { n: 'Others', p: 19 }],
    'Andhra Pradesh': [{ n: 'Visakhapatnam', p: 26 }, { n: 'Vijayawada', p: 20 }, { n: 'Guntur', p: 15 }, { n: 'Tirupati', p: 11 }, { n: 'Others', p: 28 }],
    'Odisha':         [{ n: 'Bhubaneswar', p: 28 }, { n: 'Cuttack', p: 19 }, { n: 'Rourkela', p: 14 }, { n: 'Berhampur', p: 11 }, { n: 'Others', p: 28 }],
    'Jharkhand':      [{ n: 'Ranchi', p: 27 }, { n: 'Jamshedpur', p: 22 }, { n: 'Dhanbad', p: 17 }, { n: 'Bokaro', p: 12 }, { n: 'Others', p: 22 }],
    'Assam':          [{ n: 'Guwahati', p: 32 }, { n: 'Dibrugarh', p: 16 }, { n: 'Silchar', p: 14 }, { n: 'Jorhat', p: 10 }, { n: 'Others', p: 28 }],
    'Punjab':         [{ n: 'Ludhiana', p: 25 }, { n: 'Amritsar', p: 19 }, { n: 'Jalandhar', p: 16 }, { n: 'Patiala', p: 12 }, { n: 'Others', p: 28 }],
    'Chhattisgarh':   [{ n: 'Raipur', p: 29 }, { n: 'Bhilai', p: 19 }, { n: 'Bilaspur', p: 15 }, { n: 'Durg', p: 11 }, { n: 'Others', p: 26 }],
    'Haryana':        [{ n: 'Gurugram', p: 28 }, { n: 'Faridabad', p: 20 }, { n: 'Panipat', p: 13 }, { n: 'Hisar', p: 11 }, { n: 'Others', p: 28 }],
    'Delhi NCR':      [{ n: 'New Delhi', p: 26 }, { n: 'South Delhi', p: 20 }, { n: 'Gurugram', p: 18 }, { n: 'Noida', p: 16 }, { n: 'Ghaziabad', p: 12 }, { n: 'Others', p: 8 }],
    'Uttarakhand':    [{ n: 'Dehradun', p: 31 }, { n: 'Haridwar', p: 20 }, { n: 'Nainital', p: 13 }, { n: 'Haldwani', p: 10 }, { n: 'Others', p: 26 }],
  },
};
