    ...
    render(ctx) {
      ...
      const work = [
        ...
        { role: 'Independent Masonry Contractor', org: 'Self-Employed — Rajan Masonry Works', period: 'Jan 2016 – Jan 2018', loc: 'Gurugram',
          sector: 'nongovt', relation: 'self', source: 'pan-gst', pan: 'ABCPK4321F', badge: { t: 'Verified · GST Details (via PAN)', c: 'green' } },
          ...
          <div class="hero__in">
            <div class="row between wrap gap-20">
              <div style="min-width:290px;flex:1">
                ...
                <p class="lead">One professional identity — work history, skills and credentials verified at source, and shareable with any employer, bank or ministry in seconds.</p>
