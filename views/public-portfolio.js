...
(function () {
  ...
  App.registerView('public-portfolio', {
    ...
    render(ctx) {
      // Full verified work history — public view shows every entry, no badges.
      const work = [
        { role: 'Construction Supervisor', org: 'Omaxe Ltd.', period: 'Mar 2023 – Present', loc: 'Delhi', active: true },
        { role: 'Mason Foreman', org: 'Hiranandani Group', period: 'Jun 2018 – Feb 2023', loc: 'Thane' },
        { role: 'Senior Mason', org: 'JMD Builders', period: 'Jan 2013 – May 2018', loc: 'Gurugram' },
        { role: 'Mason', org: 'L&T Construction', period: 'Feb 2011 – Dec 2012', loc: 'Noida' },
      ];
